                            ...
                            <li>
                                ...
                                <ul class="sub-menu">
                                    ...
                                    @if (Route::has('sellers.login'))
                                        ...
                                        @else
                                            <li>
                                                <a href="{{ route('sellers.login') }}"
                                                    class="text-sm text-gray-700 dark:text-gray-500 underline">Log in to your seller account</a>
                                            </li>

                                            @if (Route::has('sellers.register'))
                                                <li>
                                                    <a href="{{ route('sellers.register') }}"
                                                        class="text-sm text-gray-700 dark:text-gray-500 underline">Become A Seller</a>
                                                </li>
                                            @endif
                                        @endauth
                                    @endif
